#!/usr/bin/node
/**
 * This program parses the pŕeposition CSV file to an ordered array
 * with parsing
 */
...
/**
 * This a method that parses the preposition csv file to an array with esperanto words
 * as the first element of each subarray
 */
const prepositionTranslation = () => {
  let words = obj.from.path('./prepositions.csv').to.array((data) => {
...
module.exports = prepositionTranslation;
