#!/usr/bin/node
/**
 * This program parses the number CSV file to an ordered array
 * with parsing
 */
...
/**
 * This a method that parses the number csv file to an array with esperanto words
 * as the first element of each subarray
 */
const numberTranslation = () => {
  let words = obj.from.path('./numbers.csv').to.array((data) => {
...
module.exports = numberTranslation;
