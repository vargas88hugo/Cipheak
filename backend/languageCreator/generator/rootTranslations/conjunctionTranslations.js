#!/usr/bin/node
/**
 * This program parses the conjunction CSV file to an ordered array
 * with parsing
 */
...
/**
 * This a method that parses the conjunction csv file to an array with esperanto words
 * as the first element of each subarray
 */
const conjunctionTranslation = () => {
  let words = obj.from.path('./conjunctions.csv').to.array((data) => {
...
module.exports = conjunctionTranslation;
