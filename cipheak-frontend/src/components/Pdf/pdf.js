...
class PdfGenerator extends Component {
    ...
    jsGenerator = () => {
        ...
        let diezsieteParArray = doc.splitTextToSize(text["diezsieteParagraph"], 400);
        let diezochoParArray = doc.splitTextToSize(text["diezochoParagraph"], 400);
        ...
        let firstListeigth = doc.splitTextToSize(text["firstList"]["eigth"], 600);
        ...
        doc.text(250, 110, text["languageName"]);
        ...
        // add list of phrases
        doc.text(30, 470, firstListone, {maxWidth:500, align: "justify"});
        doc.text(30, 510, firstListsecond, {maxWidth:500, align: "justify"});
        doc.text(30, 550, firstListthird, {maxWidth:500, align: "justify"});
        ...
        doc.text(30, 770, firstListeigth, {maxWidth:600, align: "justify"});
        ...
        doc.text(30, 250, diezsieteParArray, {maxWidth: 600, align: "justify"});
